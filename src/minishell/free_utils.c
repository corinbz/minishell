...
/*   Updated: 2024/08/04 13:07:19 by erybolov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static void	free_pipe_cmd(t_pipe_cmd *pipe_cmd)
{
...
static void	free_heredoc_cmd(t_heredoc_cmd *heredoc_cmd)
{
	free_full_cmd((t_cmd *)heredoc_cmd->sub_cmd);
	free(heredoc_cmd);
}

static void	free_redir_cmd(t_redir_cmd *redir_cmd)
{
